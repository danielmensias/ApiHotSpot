...
{
    public partial class Cuarto_Piso : Form
    {
        public Cuarto_Piso()
        {
            InitializeComponent();
        ...
        private void Cuarto_Piso_Load(object sender, EventArgs e)
        {
            deshabilitar();
        }
