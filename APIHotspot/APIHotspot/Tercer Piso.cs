...
{
    public partial class Tercer_Piso : Form
    {
        public Tercer_Piso()
        {
            InitializeComponent();
        ...
        private void Tercer_Piso_Load(object sender, EventArgs e)
        {
            deshabilitar();
        }
