...
{
    public partial class Quinto_Piso : Form
    {
        public Quinto_Piso()
        {
            InitializeComponent();
        ...
        private void Quinto_Piso_Load(object sender, EventArgs e)
        {
            deshabilitar();
        }
